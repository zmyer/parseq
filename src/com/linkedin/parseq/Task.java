...
public interface Task<T> extends Promise<T>, Cancellable {
     ...
     */
    public static <T> Task<T> blocking(final String name, final Callable<? extends T> callable,
    ...
    public static <T> Task<T> blocking(final Callable<? extends T> callable, final Executor executor) {
        return blocking("blocking: " + _taskDescriptor.getDescription(callable.getClass().getName()), callable,
                executor);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6> Tuple6Task<T1, T2, T3, T4, T5, T6> par(final Task<T1> task1,
            final Task<T2> task2, final Task<T3> task3, final Task<T4> task4, final Task<T5> task5,
            final Task<T6> task6) {
        ArgumentUtil.requireNotNull(task1, "task1");
        ArgumentUtil.requireNotNull(task2, "task2");
        ArgumentUtil.requireNotNull(task3, "task3");
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> Tuple8Task<T1, T2, T3, T4, T5, T6, T7, T8> par(final Task<T1> task1,
        ...
        return new Par8Task<T1, T2, T3, T4, T5, T6, T7, T8>("par8", task1, task2, task3, task4, task5, task6, task7,
                task8);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9> Tuple9Task<T1, T2, T3, T4, T5, T6, T7, T8, T9> par(
            final Task<T1> task1, final Task<T2> task2, final Task<T3> task3, final Task<T4> task4,
            final Task<T5> task5,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Tuple13Task<T1, T2, T3, T4, T5, T6, T7, T8,
        ...
        return new Par13Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>("par13", task1, task2, task3,
                task4,
     ...
     */
    public static <T> Task<T> withRetryPolicy(String name, RetryPolicy policy,
            Function1<Integer, Task<T>> taskSupplier) {
