...
package com.linkedin.parseq.example.functional.composite.classifier;
...
import com.linkedin.parseq.example.composite.classifier.Classification;
import com.linkedin.parseq.example.composite.classifier.Classifier;
import com.linkedin.parseq.example.composite.classifier.ConnectedClassifier;
import com.linkedin.parseq.example.composite.classifier.DefaultClassifier;
import com.linkedin.parseq.example.composite.classifier.Network;
import com.linkedin.parseq.example.composite.classifier.NetworkClassifier;
import com.linkedin.parseq.example.composite.classifier.SelfClassifier;
import com.linkedin.parseq.example.composite.classifier.TruthMapClassifier;
...
public class ClassifierPlanFactory
{
  ...
  public static class ClassificationState
  {
    public final long viewerId;
    public final Set<Long> vieweeIds;
    public final Map<Long, Classification> _classified = new HashMap<Long, Classification>();
    
    public ClassificationState(long viewerId, Set<Long> vieweeIds) {
      super();
      this.viewerId = viewerId;
      this.vieweeIds = vieweeIds;
    }
  }
